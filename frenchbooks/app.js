...
const STRINGS = {
  cht: {
    ...
    f2Title: "簡易法語說明",
    f2Body: "用法語介面時，用比原著更淺的法語講清句意，讀得下去、也學得進去。",
    f3Title: "點詞與文法",
  ...
  chs: {
    ...
    f2Title: "简易法语说明",
    f2Body: "用法语界面时，用比原著更浅的法语讲清句意，读得下去、也学得进去。",
    f3Title: "点词与文法",
  ...
  en: {
    ...
    f2Body: "In the French UI, sentence meaning in easier French than the book — so you can keep reading and keep learning.",
    f3Title: "Tap & grammar",
  ...
  fr: {
    ...
    f2Body: "En interface française, le sens de la phrase en français plus accessible que le livre — on avance, on apprend.",
